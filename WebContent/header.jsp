...
<body style="background-color: #E6F9E6;">
	...
	<div class="container-fluid text-center"
		...
		<h6>Discover a new you within a second</h6>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							...
							<li><a href="index.jsp?type=boy">BOYS</a></li>
							<li><a href="index.jsp?type=girl">GIRLS</a></li>
						</ul></li>
				</ul>
			</div>
		</div>
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<li><a href="userHome.jsp?type=women">WOMES</a></li>
							<li><a href="userHome.jsp?type=men">MEN</a></li>
							<li><a href="userHome.jsp?type=boy">BOYS</a></li>
							<li><a href="userHome.jsp?type=girl">GIRLS</a></li>
						</ul></li>
					<%
					if (notf == 0) {
					%>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							...
							<li><a href="adminViewProduct.jsp?type=girl">GIRLS</a></li>
							<li><a href="adminViewProduct.jsp?type=boy">BOYS</a></li>
						</ul></li>
